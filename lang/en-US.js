export default {
  ...
  portfolio: {
    ...
    parity: "Personal finance PWA web app, open source, with encrypted data and no tracking.",
    vitreon: "Notes PWA web app, open source, with encrypted data and no tracking.",
    alere: "Industrial food company providing cafeteria services for schools, businesses, and more in Chile.",
    pharmahub: "Digital hub for the pharmaceutical industry, connecting laboratories and pharmacies in Chile.",
    sitef: "Payment solutions and financial technology systems for Venezuela.",
  ...
  experience: {
    ...
    task1ditrali: "Bug fixes for PHP systems.",
    task2ditrali: "PHP system development.",
    task3ditrali: "Migration from CodeIgniter 4 and PrestaShop 1.7.",
